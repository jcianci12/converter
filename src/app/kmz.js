!(function (e, t) {
          ...
          e.map((e) =>
            (function (e) {
              return new Promise((t, o) => {
                ...
                n.addEventListener("load", t.bind(e), { once: !0 }),
                  (n.src = e),
  ...
  function r(e, t) {
    let [o, n] = (function (e) {
      ...
      i = e.getElementsByTagName("href")[0],
      r = e.getElementsByTagName("color")[0],
      a = e.getElementsByTagName("Icon")[0],
      s = {};
    return (
      !i && a && (i = a.getElementsByTagName("href")[0]),
      (i = i.childNodes[0].nodeValue),
      (i = t.icons[i] || i),
      r &&
      ...
      n && (s.rotation = n),
      new L.KMZImageOverlay(i, o, { opacity: s.opacity, angle: s.rotation })
    );
  }
  function a(e) {
    var t = e;
    if (e instanceof ArrayBuffer) {
      var o = (t = String.fromCharCode.apply(null, new Uint8Array(e)))
  ...
  const s = (L.KMZLayer = L.FeatureGroup.extend({
      ...
      return (function (e) {
        return new Promise((t, o) => {
          ...
          n.open("GET", e),
            ...
            (n.onload = () => {
              4 !== n.readyState || (200 !== n.status && 0 !== n.status)
                ? t("")
                : t(n.response || n.responseText);
            }),
            (n.onerror = () =>
              o("Error " + n.status + " while fetching remote file: " + e)),
            n.send();
        });
      })(e).then((t) => this._parse(t, { name: o(e), icons: {} }));
    },
    _parse: function (e, t) {
      return (
        (o = e),
    ...
    _parseKMZ: function (e, o) {
      ...
      new Promise((e, t) => {
        ...
        var i = t(e),
          ...
          a = e[i];
        (o.icons = r.reduce((t, o) => ((t[o] = e[o]), t), {})),
          this._parseKML(a, o);
      });
    },
    _parseKML: function (e, t) {
      var o = a(e),
        ...
        i = (this.options.geometryToLayer || this._geometryToLayer).call(
          this,
          n,
          o
        );
      this.addLayer(i),
        this.fire("load", { layer: i, name: n.properties.name });
    },
    _geometryToLayer: function (e, t) {
        ...
        n = L.geoJson(e, {
          pointToLayer: (t, n) =>
            o
              ? L.kmzMarker(n, {
                  iconUrl:
                    e.properties.icons[t.properties.icon] || t.properties.icon,
                  iconSize: [28, 28],
                  iconAnchor: [14, 14],
            ...
            if (this.options.ballon) {
              ...
              (n || i) &&
                (this.options.bindPopup &&
                  t.bindPopup("<div><b>" + n + "</b><br>" + i + "</div>"),
      ...
      for (let t, o = 0; o < i.length; o++)
        (t = r(i[o], e.properties)), t && n.addLayer(t);
      return n;
    },
